...
cvevents <- function(tbl, when, what, where, details) {
  if (knitr::is_latex_output()) {
    ...
    # HTML output
    for(i in 1:nrow(tbl)) {
      cat('<div class="cv-event">\n')
      cat('  <div class="cv-event-header">\n')
      cat('    <div>\n')
      cat('      <span class="cv-event-title">', tbl[[what]][i], '</span>\n')
      cat('      <span class="cv-event-institution"> - ', tbl[[where]][i], '</span>\n')
      cat('    </div>\n')
      cat('    <span class="cv-event-date">', tbl[[when]][i], '</span>\n')
      cat('  </div>\n')
      cat('  <ul class="cv-event-details">\n')
      for(detail in tbl[[details]][[i]]) {
        cat('    <li>', detail, '</li>\n')
      }
      cat('  </ul>\n')
      cat('</div>\n')
